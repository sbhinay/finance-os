...
- Dashboard, Daily Log, Transaction History, Assets, Recurring, Business tax, Import / Export, Categories, Hours & Contracts, and Scan Statement surfaces are in active visual refresh so desktop and phone layouts stay usable from the same code path.
