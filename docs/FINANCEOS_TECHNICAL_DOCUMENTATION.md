...
- Dashboard, Daily Log, Transaction History, Assets, Recurring, Business tax, and Import / Export surfaces are in active visual refresh so desktop and phone layouts stay usable from the same code path.
